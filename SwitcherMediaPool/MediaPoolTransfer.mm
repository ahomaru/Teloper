...
MediaPoolTransfer::MediaPoolTransfer(SwitcherMediaPoolAppDelegate* uiDelegate, NSWindow* window, IBMDSwitcher* switcher, IBMDSwitcherMediaPool* mediaPool)
...
StillTransfer::StillTransfer(SwitcherMediaPoolAppDelegate* uiDelegate, NSWindow* window, IBMDSwitcher* switcher, IBMDSwitcherMediaPool* mediaPool, IBMDSwitcherStills* stills)
 :	MediaPoolTransfer(uiDelegate, window, switcher, mediaPool),
	mStills(stills),
...
error:
	...
	// show a message box
	NSBeginAlertSheet(@"Error", @"OK", nil, nil, mWindow, mUIDelegate, NULL, NULL, mWindow, @"Still transfer failed");
...
error:
	...
	// show a message box
	NSBeginAlertSheet(@"Error", @"OK", nil, nil, mWindow, mUIDelegate, NULL, NULL, mWindow, @"Clip transfer failed");
