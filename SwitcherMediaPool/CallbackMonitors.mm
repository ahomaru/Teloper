...
HRESULT MediaPlayerCallback::Source2Changed(void)
{
    [mUIDelegate performSelectorOnMainThread:@selector(onMediaPlayer2SourceChanged) withObject:nil waitUntilDone:NO];
    return S_OK;
}
...
{
	// switcher event changes ignored by this sample app
	return S_OK;
}

HRESULT SwitcherCallback::Disconnected(void)
{
