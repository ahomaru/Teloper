...
protected:
	MediaPoolTransfer(SwitcherMediaPoolAppDelegate* uiDelegate, NSWindow* window, IBMDSwitcher* switcher, IBMDSwitcherMediaPool* mediaPool);
	...
	SwitcherMediaPoolAppDelegate*	mUIDelegate; // app delegate used by performSelectorOnMainThread
